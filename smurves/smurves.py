...
def check(n_curves,
    ...
    incorrect_inputs = np.zeros(13, dtype = bool)
    ...
    if (log_scale is True):
        ...
        if ((np.log10(convergence_point).is_integer() is False)
            and (convergence_point is not None)):
